...
struct ProfileView: View {
    ...
    // For picking a new profile photo - consolidated to only use selectedImageData
...
extension ProfileView {
    ...
    var editingFields: some View {
        ...
        // Simplified to a single button that opens the image source dialog
        ...
        .sheet(isPresented: $isShowingImagePicker, onDismiss: {
            // Check if image data was successfully selected
            if let imageData = selectedImageData {
                print("Image picker dismissed with \(imageData.count) bytes of image data")
            } else {
                print("Image picker dismissed without setting image data")
            }
        }) {
            ...
            case .photoLibrary:
                // Fix: The initializer expects a binding named 'selectedImage' but we're passing selectedImageData
                // The parameter name in PhotoLibraryPicker is misleading - need to use the correct initializer
